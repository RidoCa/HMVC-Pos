 <div class="container my-4">
     <h6 class="page-subtitle">List Categories
        ...
        ?>
             <div class="card shadow-sm border-0 mb-3">
                 <div class="card-body">
                     <div class="row">
                         <div class="col">
                             <h5 class="font-weight-normal mb-1"><?= $row['category_name'] ?></h5>
                         </div>
                         <div class="col-auto align-self-center">
                             <a class="btn btn-35 default-shadow border-0 bg-danger btnDelete" title="delete" data-code="<?= $row['category_id'] ?>">
                                 <i class="far fa-trash-alt"></i>
                             </a>
                             <a class="btn btn-35 default-shadow border-0 bg-warning btnEdit" title="edit" data-code="<?= $row['category_id'] ?>">
                 ...
                 <form id="form">
                     ...
                     <div class="modal-body">
                         <div class="form-group">
                             <label class="text-mute small">Category Acronim</label>
                             <input type="text" class="form-control rounded-right-custom rounded-left-custom" id="acronim" name="acronim" placeholder="Example : MKN" maxlength="3">
                             <span class="help-block small text-danger"></span>
                         </div>
                         <div class="form-group">
                             <label class="text-mute small">Category</label>
                             <input type="text" class="form-control rounded-right-custom rounded-left-custom" id="category" name="category" placeholder="Example : Makanan">
                             <span class="help-block small text-danger"></span>
                         </div>
         ...
         $('.btnEdit').click(function() {
             ...
             $.ajax({
                 ...
                 success: function(data) {
                     $('[name="acronim"]').val(data.category_id).prop("readonly", true);

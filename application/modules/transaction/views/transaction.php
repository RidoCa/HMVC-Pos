<div class="container my-4">
    <div class="form-group">
        <!-- <input type="text" class="form-control rounded-right-custom rounded-left-custom" id="search" name="search" placeholder="Search"> -->
        <button type="button" class="btn btn-primary btn-block rounded-right-custom rounded-left-custom" onclick="add()">
                        ...
                        <?php for ($y = 0; $y < count($list[$i]['product']); $y++) { ?>
                            <div class="swiper-slide w-auto p-2 swiper-slide-active" style="margin-right: 10px;">
                                <div class="card shadow-sm w-200 border-0">
                                    <a href="<?= base_url() . 'transaction/detail/' . $list[$i]['product_id'][$y]  ?>">
    ...
    <div class="footer-tabs footer-spaces border-top text-left">
            <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                <li class="nav-item" style="width: 100%">
                    <button class="btn btn-block btn-default default-shadow rounded-right-custom rounded-left-custom" onclick="listpending()">
...
<script type="text/javascript">
    ...
    function listpending() {
        window.location.href = "<?= base_url() . 'pending' ?>";
    }
</script>